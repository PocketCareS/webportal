  ...
  async componentDidMount() {
    ...
    Object.entries(response.data.aggregatedResponse).map(([key, value]) => {
      ...
      const LESS_THAN_5 = {
        ...
        y:
          value.totalContacts.LESS_THAN_5 !== undefined
            ? value.totalContacts.LESS_THAN_5
            : 0,
      };
      const GREATER_THAN_5_LESS_THAN_10 = {
        ...
        y:
          value.totalContacts.GREATER_THAN_5_LESS_THAN_10 !== undefined
            ? value.totalContacts.GREATER_THAN_5_LESS_THAN_10
            : 0,
      };
      const GREATER_THAN_10 = {
        ...
        y:
          value.totalContacts.GREATER_THAN_10 !== undefined
            ? value.totalContacts.GREATER_THAN_10
            : 0,
      };
