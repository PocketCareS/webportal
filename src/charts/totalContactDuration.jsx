  ...
  async componentDidMount() {
    const response = await axios.get(
      baseUrl +
        ...
        this.props.startDateEpoch +
        "&endDate=" +
        this.props.endDateEpoch +
    ...
    Object.entries(response.data.aggregatedResponse).map(([key, value]) => {
      ...
      const LESS_THAN_5 = {
        ...
        y:
          value.totalContactsDuration.LESS_THAN_5 !== undefined
            ? value.totalContactsDuration.LESS_THAN_5
            : 0,
      };
      const GREATER_THAN_5_LESS_THAN_10 = {
        ...
        y:
          value.totalContactsDuration.GREATER_THAN_5_LESS_THAN_10 !== undefined
            ? value.totalContactsDuration.GREATER_THAN_5_LESS_THAN_10
            : 0,
      };
      const GREATER_THAN_10 = {
        ...
        y:
          value.totalContactsDuration.GREATER_THAN_10 !== undefined
            ? value.totalContactsDuration.GREATER_THAN_10
            : 0,
      };
